...
<script>
  ...
  import NavBar from 'components/common/navbar/NavBar'
    ...
    data: function () {
		  return {
		    orderList: [
          {icon: '#icon-message', iconColor: '#ff8198', info: '我的消息'},
          {icon: '#icon-shangpinguanli', iconColor: '#fc7b53', info: '积分商城'},
          {icon: '#icon-VIP', iconColor: '#ffc636', info: '会员卡'},
        ],
        serviceList: [
          {icon: '#icon-iconfontcart-copy', iconColor: '#ff8198', info: '我的购物车'},
          {icon: '#icon-app', iconColor: '#ff8198', info: '下载购物APP'},
        ]
      }
    },
    mounted: function () {
